...
fn task_1(instruction_list: &Vec<String>, starting_pos: i32) -> i32 {
...
fn main() {
    ...
    let numb = 50;
    let res = task_1(&instruction_data, numb);
    let duration = start.elapsed().as_secs_f64();
    println!("Task duration: {}s", duration);
    println!("Task duration: {}ms", (duration * 1_000.0));
    println!("Task duration: {}µs", (duration * 1_000_000.0));
    println!("Task duration: {}ns", (duration * 1_000_000_000.0));
    println!("Task duration: {}ps", (duration * 1_000_000_000_000.0));

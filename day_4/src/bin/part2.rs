...
fn run_sim(accessed_rolls: &mut u64, roll_set: &BTreeSet<PaperRoll>) -> BTreeSet<PaperRoll> {
    let mut new_roll_set = BTreeSet::<PaperRoll>::new();
...
fn generate_set(data: &str, roll_set: &mut BTreeSet<PaperRoll>) {
